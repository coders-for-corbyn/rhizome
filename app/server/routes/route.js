  ...
  exec(req, res) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this._authenticate()
        ...
        .then(Logging.Promise.logTimerException(`PERFORMANCE: [${this.verb.toUpperCase()}] ${this.path.toUpperCase()}`, this._timer, 1))
        // .then(Logging.Promise.log(`DONE: ${this.name} [${this._timer.interval.toFixed(3)}]`))
        .then(resolve, reject)
